...
namespace plusminus.Controllers
{
    public class IncomesController : ControllerBase
    {
        ...
        [HttpGet("incomes/{id}")]
        public async Task<ActionResult<ServiceResponse<List<GetIncomesDto>>>> GetExpanses(int id)
        {
            return Ok(await _incomesService.GetIncomesByUserId(id));
        }
        ...
        {
            return Ok(await _incomesService.AddIncomes(newIncomes));
        }
        ...
        {
            return Ok(await _incomesService.UpdateIncomes(updatedIncomes));
        }

        [HttpDelete("incomes/{id}")]
        public async Task<ActionResult<ServiceResponse<List<GetIncomesDto>>>> DeleteExpenses(int id)
        {
            return Ok(await _incomesService.DeleteIncomesById(id));
        }
    }
}
